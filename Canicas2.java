...
public class Canicas2 {
    public void imprimirPorCanicas( ) {
        short total = 158;
        float r = (int) (total * 13.0 / 100);
        System.out.println("Las canicas rojas que tiene Carlitos son: " + r);
        float a = (int) (total * 22.0 / 100);
        ...
        System.out.println("Las canicas bonbochas que tiene Carlitos son: " + bon);
    }
}
